...
import logo from '../../../src/images/Black Illustrated School Logo.png'
const Footer = () => {
    return (
        <footer className="bg-gray-900 pt-10 bg-opacity-80 text-gray-400 body-font">
    ...
    <a href="/" className="text-xl font-bold">
        <img
            src={logo}
            alt="Logo"
            className="h-52 w-auto object-contain rounded-full"
        />
    </a>
</div>
            ...
            <div className="bg-gray-900 bg-opacity-80">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-400 text-sm text-center sm:text-left">
                        © 2020 Tailblocks —
                        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-500 ml-1 hover:text-white" target="_blank">
                            @knyttneve
                        </a>
                    </p>
